        ...
        switch (topic.type) {
            case 'configure_j1':
                ...
                */
                ...
                this.writeAttrFromJson(options, 'installed_open_limit_tilt', 'installedOpenLimitTiltDegree', true);
                this.writeAttrFromJson(options, 'installed_closed_limit_tilt', 'installedClosedLimitTiltDegree', true);
