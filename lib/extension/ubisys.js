    ...
    onMQTTMessage(topic, message) {
        ...
        switch (topic.type) {
            ...
            case 'configure_inputs':
                ...
                // TBD: does not seem to work (yet), need to check array handling on writes
                var options = { log, 'entity': entity, cluster: 'manuSpecificUbisysDeviceSetup', 'json': json, steps: [] };
