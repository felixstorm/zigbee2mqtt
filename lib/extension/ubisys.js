        ...
        switch (key) {
            case 'calibrate_j1':
                ...
                var steps = [
                    ...
                    function() { return Q.delay(5000); },

                    this.writeNamed(entity, 'windowCoveringType', 8, cfg.ubisys),
                    ...
                    function() { return Q.delay(1000); },

                    this.writeNamed(entity, 'windowCoveringMode', 0x02),
                    function() { return Q.delay(1000); },
                    this.zclCommand(entity, 'downClose'),
                    function() { return Q.delay(3000); },
                    this.zclCommand(entity, 'upOpen'),
                    function() { return Q.delay(10000); },
                    this.zclCommand(entity, 'downClose'),
                    function() { return Q.delay(45000); },
                    this.zclCommand(entity, 'upOpen'),
                    function() { return Q.delay(45000); },
                ]
